...
{
    public partial class dsoToday : Form
    {
        ...
        private void dsoToday_Load(object sender, EventArgs e)
        {
        ...
        private void userComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Query += "FROM tblReceipts_ WHERE cast(activity_date as date) = @today AND user_id = @user";
                ...
                if (rd.HasRows)//Meaning at least a row of data was found from the DB
                {
                    ...
                    conn.Close();
                    conn.Dispose();
                    countLabel.Text = "Total count for today's activities: " + count;
                }
                else
                {
