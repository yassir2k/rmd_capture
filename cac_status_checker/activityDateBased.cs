...
{
    public partial class activityDateBased : Form
    {
        ToolTip MyToolTip = new ToolTip();
        public activityDateBased()
        {
            InitializeComponent();
        }
        ...
        private void userComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string Query = "SELECT comp_name, rc, receipt_no, amount, agent_id, activity_date, user_id ";
                Query += "FROM COMPANIES_ WHERE cast(activity_date as date) between @from and @to AND user_id = @user";
        ...
        private void activityDateBased_Load(object sender, EventArgs e)
        {
